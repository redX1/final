            ...
            <div class="col-md-10">
                ...
                <div class="tab-content">
                                                ...
                                                <div class="card-header" id="heading{{$emission->id}}">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$emission->id}}" aria-expanded="true" aria-controls="collapse{{$emission->id}}">
                                                            <span>{{$emission->name}}</span> {{$emission->numero}}
                                                        </button>
                                                    </h5>
                                                </div>
                                                                    ...
                                                                    <div class="card-header" id="heading{{$emission->id.''.$emisDiff->id}}">
                                                                        <h5 class="mb-0">
                                                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$emission->id.''.$emisDiff->id}}" aria-expanded="true" aria-controls="collapse{{$emission->id.''.$emisDiff->id}}">
                                                                                {{$emisDiff->day.' '.$emisDiff->begin_at.' '.$emisDiff->end_at}}
                                                                            </button>
                                                                        </h5>
                                                                    </div>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col-sm-4 border-right">
                                                                                                                <div class="description-block">
                                                                                                                    <h5 class="description-header"><a href="">{{\App\Models\Participant::CountParticipantQuiz($emission->numero,$questDiff)}}</a> </h5>
                                                                                                            ...
                                                                                                            <div class="col-sm-4 border-right">
                                                                                                                <div class="description-block">
                                                                                                                    <h5 class="description-header">{{\App\Models\Participant::CountGagnantQuiz($emission->numero,$questDiff,$question)}}</h5>
                    ...
                    <div class="tab-pane fade " id="panel3" role="tabpanel">
                        ...
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#quizModal">
                            Ajouter un quiz
                        </button>
                        {{--Fin du boutton--}}
                                                ...
                                                <div class="row">
                                                    ...
                                                    @if(! $questions->isEmpty())
                                                        ...
                                                        @foreach($questions as $question)
                                                            ...
                                                            {{--//Insertion de la fenetre modale--}}
